...
#pragma acc parallel loop gang private(  Q0[0:3], Q1[0:3], Q2[0:3], Q3[0:3], xyzInt[0:3], normal[0:3], dotProduct, dotProduct2 ) \
...
#pragma acc enter data copyin(Ray[0:3], blocked[0:nFacesB+1])
#pragma acc loop 
	  ...
	  #pragma acc exit data copyout(blocked [0:nFacesB+1],Ray[0:3])
