...
double  * * Array2D_double_acc(int nRows,int nCols)
{
  double *myArray        = (double*)  acc_malloc( nCols*nRows * sizeof(double ) );
  double * * myArray_ptr = (double**) acc_malloc( nRows *       sizeof(double*) );

  int count = 0;
  
#pragma acc parallel loop deviceptr(myArray,myArray_ptr) present(myArray, myArray_ptr)
...
int  * * Array2D_int_acc(int nRows,int nCols)
{
  int *myArray        = (int*)  acc_malloc( nCols*nRows * sizeof(int ) );
  int * * myArray_ptr = (int**) acc_malloc( nRows *       sizeof(int*) );
